...
EXERCISE_GENERATION_PROMPT = (
    ...
    "IMPORTANT — DIFFICULTÉ NON NÉGOCIABLE : le niveau indiqué dans NIVEAU STRICT est prioritaire sur toute autre consigne. "
    "Ne dépasse jamais ses limites de longueur, de nombre de contraintes ou de complexité. "
    "Pour un GRAND DÉBUTANT, les trois exercices doivent être immédiatement faisables, concrets et rassurants : "
    "une seule action d'écriture, une seule contrainte maximum, aucun jargon et aucune structure sophistiquée. "
    "Avant de répondre, vérifie séparément chaque exercice contre le niveau ; si un exercice est trop difficile, simplifie-le.\n\n"
    "{avoid_repeats}\n\n"
    "{student_record}\n\n"
